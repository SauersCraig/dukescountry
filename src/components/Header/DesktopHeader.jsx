  ...
  return (
    <nav className="deskTopContainer">
      <div className="item1 menuLinks">
        <a href="https://www.youtube.com/watch?v=Hz_cWTMz-48" target="_blank" aria-label="Link takes you to a video about Duke's Mayo.">
          WATCH THE VIDEO
        </a>
      ...
      <div className="item3 menuLinks">
        ...
        <a href="https://dukesmayo.com/pages/classic" target="_blank" aria-label="Learn more about Duke's Mayo Football games on Duke's Mayo E-Com Site">
          DUKE'S MAYO BOWL
        </a>
      </div>
    </nav>
